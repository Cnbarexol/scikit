...
if __name__ == '__main__':
    dt_heart=pd.read_csv('./Datos/Reporte_Fecha_15.csv')
...
#datos = pd.read_csv('C:/Users/Usuario/OneDrive/Escritorio/UNIVERSIDAD/6 S/Mineria de datos/sensor/Reporte_Fecha_15.csv')
#datos = pd.read_csv('C:/Users/Usuario/OneDrive/Escritorio/UNIVERSIDAD/6 S/Mineria de datos/sensor/Reporte Fecha 15.csv', header= None)
#datos.to_csv('C:/Users/Usuario/OneDrive/Escritorio/UNIVERSIDAD/6 S/Mineria de datos/sensor/Reporte Fecha 1508.csv')
#print(datos.head())




#dato1 = pd.read_csv('./Datos/Reporte_Fecha_15.csv')
#dato2 = pd.read_csv('./Datos/Reporte_Fecha_23.csv')

#df_concatenado = pd.concat([dato1, dato2])

#df_concatenado.to_csv('./Datos/archivo_unido.csv', index=False)
